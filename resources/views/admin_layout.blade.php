...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Dashboard of admin panel</title>
	...
	<!--[if lt IE 9]>
		...
		<link id="ie-style" href={{asset('')}}/ie.css" rel="stylesheet">
	<![endif]-->
	
	<!--[if IE 9]>
		<link id="ie9style" href={{asset('')}}/ie9.css" rel="stylesheet">
	<![endif]-->
...
<body>
	...
	<footer>
		...
		<p>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="http://admintemplates.co/" alt="Bootstrap Admin Templates">Md. Sarowar Al-Amin</a></span>
		</p>
