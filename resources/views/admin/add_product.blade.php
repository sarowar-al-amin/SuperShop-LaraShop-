                            ...
                            <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" name="catagory_id">
                                      ...
                                      <?php
                                           $all_publised_category = DB::table('tbl_catagories')
										    ->where('publication_status',1)
										    ->get();
							              foreach($all_publised_category as $v_category){?>
                                            <option value="{{$v_category->catagory_id}}">{{$v_category->catagory_name}}</option>
                                        <?php }?>
								  </select>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
                                  ...
                                  <option> Select Manufacture</option>
                                      <?php
                                            $all_publised_manufactures = DB::table('tbl_manufactures')
													  ->where('publication_status',1)
													  ->get();
							                foreach($all_publised_manufactures as $v_manufacture){?>
